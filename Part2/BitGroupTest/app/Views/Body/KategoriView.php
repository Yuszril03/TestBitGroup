                     ...
                     <div class="card-body">
                                     ...
                                     <div class="modal-body">
                                         <form id="myForm" action="">
                                             <div class="form-group">
                                                 ...
                                                 <input type="text" onkeyup="up(this)" class="form-control" name="nama" id="nama" placeholder="Masukan Nama Kategori">
                         ...
                         <div class="modal fade" id="hapus" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                             <div class="modal-dialog">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h5 class="modal-title" id="staticBackdropLabelH">Hapus Kategori</h5>
                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                             <span aria-hidden="true">&times;</span>
                                         </button>
                                     </div>
                                        ...
                                        ?>
                                         <tr>
                                             ...
                                             <td>
                                                 ...
                                                 <button onclick="modal(<?= $rows['id_kat'] ?>)" class="btn btn-warning btn-sm"><i class="fa fa-pen"></i></button>
                                                 <button onclick="modalH(<?= $rows['id_kat'] ?>)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                             </td>
                                         </tr>
                                     <?php $no++;
                                        } ?>
             ...
             if (id == 00) {
                 ...
                 $.ajax({
                     ...
                     success: function(data) {
                         ...
                         document.getElementById(arryForm[0]).value = data['Kategori'][0].name_kat;
                         document.getElementById('idData').value = data['Kategori'][0].id_kat;
                         $('#staticBackdrop').modal('show')
